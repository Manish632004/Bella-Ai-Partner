...
def Content(Topic):
    ...
    def ContentWriterAI(prompt):
        ...
        Answer = Answer.replace("</s>", "") # Remove unwanted tokens form the response.
...
def YouTubeSearch(Topic):
    Url4Search = f"https://www.youtube.com/results?search_query ={Topic}" #constract the Youtube search URl.
...
async def Automation(commands: list[str]):
    ...
    async for result in TranslateAndExecute(commands): # Trasnlate and execute commands.
